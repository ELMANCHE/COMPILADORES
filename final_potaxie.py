from sintactico_potaxie import nodoPadre
from semantico_potaxie import symbol_table

print("\nComenzando el gogogo final ( ensamblador)\n")
...
# Guardar el código assembly en un archivo
    with open('ensamblador_gogogo.asm', 'w') as f:
        for linea in codigo_assembly:
            f.write(linea + '\n')
            print(linea)
# Mensaje de éxito
    print(f"\nCompletaste el nivel final del gogogo")
