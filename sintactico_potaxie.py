...
from tokenspotaxie import tokens_list
...
tabla_sintactica = pd.read_csv("prueba30pipipi.csv", index_col=0)
count = 1
...
while True:
    ...
    if stack[0].simboloLex == "$" and Token[0].type == "$":
        # Si se cumple, imprimir un mensaje indicando que todo salió bien y salir del bucle while
        print("_____________________________________________\n")
        print("TODO SALIO BIEN NO TE PREOCUPES")
        print("_____________________________________________\n")
        break
